    ...
    namespace imgproc {
        namespace icp {
            ...
            struct RegistrationResult
            {
                ...
                float fitness_;
                //限制在一个像素内
                Mat3x3f clamp_transform_to_1pixel;
            };
            ...
            RegistrationResult ICP2D_Point2Plane(std::vector<Vec2f>& model_pcd,
                const Scene scene,
                const ICPConvergenceCriteria criteria = ICPConvergenceCriteria());

            extern template RegistrationResult ICP2D_Point2Plane(std::vector<Vec2f>& model_pcd, const Scene_edge scene,
            ...
            struct thrust__pcd2Ab
            {
                ...
                Vec11f operator()(const Vec2f& src_pcd) const {
                    Vec11f result;
            ...
            struct thrust__plus {
                Vec11f operator()(const Vec11f& in1, const Vec11f& in2) const {
                    return in1 + in2;
                }
            };
