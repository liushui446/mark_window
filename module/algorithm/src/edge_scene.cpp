...
#define CANNY_SHIFT 15
        ...
        */
        ...
        void Scene_edge::init_Scene_edge(cv::Mat img, std::vector<sm::imgproc::Vec2f>& pcd_buffer,
            std::vector<sm::imgproc::Vec2f>& normal_buffer, float max_dist_diff)
        {
            width = img.cols;
            height = img.rows;
            ...
            cv::Mat blur;
            GaussianBlur(gray, blur, cv::Size(5, 5), alpha, alpha);
