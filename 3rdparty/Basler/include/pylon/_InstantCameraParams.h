...
namespace Basler_InstantCameraParams
{
    ...
    //**************************************************************************************************
    // Parameter class CInstantCameraParams_Params_v10_0_0
    //**************************************************************************************************
    ...
    The code sample \ref sample_Grab shows the usage by setting the MaxNumBuffer parameter.
    */
    class PYLONBASE_API CInstantCameraParams_Params_v10_0_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    ...
    //! \cond HIDE_CLASS_METHODS
        ...
        //! Constructor
        CInstantCameraParams_Params_v10_0_0( void );
    ...
    private:
        class CInstantCameraParams_Params_v10_0_0_Data;
        CInstantCameraParams_Params_v10_0_0_Data* m_pCInstantCameraParams_Params_v10_0_0_Data;
    ...
    //! \cond HIDE_CLASS_METHODS
        ...
        CInstantCameraParams_Params_v10_0_0(CInstantCameraParams_Params_v10_0_0&);

        //! not implemented assignment operator
        CInstantCameraParams_Params_v10_0_0& operator=(CInstantCameraParams_Params_v10_0_0&);
    ...
    The code sample \ref sample_Grab shows the usage by setting the MaxNumBuffer parameter.
    */
    class CInstantCameraParams_Params : public CInstantCameraParams_Params_v10_0_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    protected:
        ...
        {
            CInstantCameraParams_Params_v10_0_0::_Initialize( pNodeMap );
        }
        //! \endcond
    };
} // namespace Basler_InstantCameraParams
