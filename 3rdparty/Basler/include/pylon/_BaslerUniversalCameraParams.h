...
namespace Basler_UniversalCameraParams
{
    ...
    enum AutoFunctionProfileEnums
    {
        ...
        AutoFunctionProfile_MinimizeExposureTime,  //!< Exposure time is kept as low as possible - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB and pulse USB
        ...
        AutoFunctionProfile_MinimizeGain,  //!< Gain is kept as low as possible - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB and pulse USB
    ...
    {
        AutoFunctionROISelector_ROI1,  //!< Auto function ROI 1 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        AutoFunctionROISelector_ROI2  //!< Auto function ROI 2 can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };
    ...
    {
        BalanceRatioSelector_Blue,  //!< Balance ratio is applied to the blue channel - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BalanceRatioSelector_Green,  //!< Balance ratio is applied to the green channel - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BalanceRatioSelector_Red  //!< Balance ratio is applied to the red channel - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };
    ...
    enum BalanceWhiteAutoEnums
    {
        ...
        BalanceWhiteAuto_Off,  //!< The Balance White Auto auto function is disabled - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BalanceWhiteAuto_Once  //!< White balance is adjusted automatically to reach the specified target value - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };
    ...
    {
        BslChunkAutoBrightnessStatus_Disabled,  //!< Target brightness adjustments are disabled, i e , Gain Auto and Exposure Auto are set to Off   - Applies to: ace 2 GigE, ace 2 USB, dart GigE and dart USB
        BslChunkAutoBrightnessStatus_TargetNotReached,  //!< Target brightness adjustments are enabled, but the target brightness value has not been reached - Applies to: ace 2 GigE, ace 2 USB, dart GigE and dart USB
        BslChunkAutoBrightnessStatus_TargetReached  //!< Target brightness adjustments are enabled, and the target brightness value has been reached - Applies to: ace 2 GigE, ace 2 USB, dart GigE and dart USB
    };
    ...
    {
        BslColorAdjustmentSelector_Blue,  //!< Colors with a predominant blue component can be adjusted - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslColorAdjustmentSelector_Cyan,  //!< Colors with a predominant cyan component can be adjusted - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslColorAdjustmentSelector_Green,  //!< Colors with a predominant green component can be adjusted - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslColorAdjustmentSelector_Magenta,  //!< Colors with a predominant magenta component can be adjusted - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslColorAdjustmentSelector_Red,  //!< Colors with a predominant red component can be adjusted - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslColorAdjustmentSelector_Yellow  //!< Colors with a predominant yellow component can be adjusted - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };

    //! Valid values for BslColorSpace
    enum BslColorSpaceEnums
    {
        BslColorSpace_Off,  //!< No additional gamma correction value is applied - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslColorSpace_sRgb  //!< The color space is set to sRGB - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };
    ...
    {
        BslConversionGainMode_High,  //!< The conversion gain mode is set to High - Applies to: ace 2 GigE and ace 2 USB
        BslConversionGainMode_Low  //!< The conversion gain mode is set to Low - Applies to: ace 2 GigE and ace 2 USB
    };
    ...
    enum BslLightSourcePresetEnums
    {
        ...
        BslLightSourcePreset_Daylight5000K,  //!< The light source preset for image acquisitions with daylight of 5000 K is selected - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslLightSourcePreset_Daylight6500K,  //!< The light source preset for image acquisitions with daylight of 6500 K is selected - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        BslLightSourcePreset_FactoryLED6000K,  //!< The light source preset for image acquisitions with LED light is selected - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        BslLightSourcePreset_Off,  //!< No light source preset is selected - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    ...
    {
        BslLightSourcePresetFeatureSelector_ColorAdjustment,  //!< Adjustment of the Color Adjustment feature can be enabled or disabled - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslLightSourcePresetFeatureSelector_ColorTransformation,  //!< Adjustment of the Color Transformation feature can be enabled or disabled - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        BslLightSourcePresetFeatureSelector_WhiteBalance  //!< Adjustment of the Balance White feature can be enabled or disabled - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };
    ...
    {
        ChunkSelector_AutoBrightnessStatus,  //!< The Auto Brightness Status chunk can be enabled - Applies to: ace 2 GigE, ace 2 USB, dart GigE and dart USB
    ...
    {
        ColorTransformationSelector_RGBtoRGB,  //!< Color transformation from RGB to RGB will be performed - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    ...
    {
        ColorTransformationValueSelector_Gain00,  //!< The desired color transformation value can be entered at the position row 0 and column 0 - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ColorTransformationValueSelector_Gain01,  //!< The desired color transformation value can be entered at the position row 0 and column 1 - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ColorTransformationValueSelector_Gain02,  //!< The desired color transformation value can be entered at the position row 0 and column 2 - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ColorTransformationValueSelector_Gain10,  //!< The desired color transformation value can be entered at the position row 1 and column 0 - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ColorTransformationValueSelector_Gain11,  //!< The desired color transformation value can be entered at the position row 1 and column 1 - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ColorTransformationValueSelector_Gain12,  //!< The desired color transformation value can be entered at the position row 1 and column 2 - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ColorTransformationValueSelector_Gain20,  //!< The desired color transformation value can be entered at the position row 2 and column 0 - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ColorTransformationValueSelector_Gain21,  //!< The desired color transformation value can be entered at the position row 2 and column 1 - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ColorTransformationValueSelector_Gain22,  //!< The desired color transformation value can be entered at the position row 2 and column 2 - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ColorTransformationValueSelector_Offset0,  //!< The desired color transformation value can be entered in row 0 of the offset matrix - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ColorTransformationValueSelector_Offset1,  //!< The desired color transformation value can be entered in row 1 of the offset matrix - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ColorTransformationValueSelector_Offset2  //!< The desired color transformation value can be entered in row 2 of the offset matrix - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    };
    ...
    enum DeviceLinkThroughputLimitModeEnums
    {
        ...
        DeviceLinkThroughputLimitMode_On  //!< The Device Link Throughput Limit parameter is enabled - Applies to: CamEmu, Stereo ace, ace 2 GigE, ace 2 USB, ace USB, dart GigE, dart USB, pulse USB, racer 2S 5GigE and racer 2S GigE
    };
    ...
    {
        ExposureAuto_Continuous,  //!< The exposure time is adjusted continuously while images are being acquired - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB and pulse USB
        ExposureAuto_Off,  //!< Automatic exposure time adjustment is disabled - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB and pulse USB
        ExposureAuto_Once  //!< The exposure time is adjusted automatically to reach the specified target value - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB and pulse USB
    };
    ...
    {
        ExposureTimeMode_Common,  //!< The same exposure time is used for all components - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    ...
    enum GainAutoEnums
    {
        GainAuto_Continuous,  //!< The gain is adjusted continuously while images are being acquired - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB and pulse USB
        GainAuto_Off,  //!< Automatic gain adjustment is disabled - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB and pulse USB
        GainAuto_Once  //!< The gain is adjusted automatically to reach the specifed target value - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB and pulse USB
    };
    ...
    enum PixelFormatEnums
    {
        ...
        PixelFormat_RGB8,  //!< The pixel format is set to RGB 8 - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        PixelFormat_YUV422_8,  //!< The pixel format is set to YUV 4:2:2 8 bit packed - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart MIPI, dart USB and racer 2S CXP
    ...
    enum PixelSizeEnums
    {
        ...
        PixelSize_Bpp32,  //!< The pixel depth in the acquired images is 32 bits per pixel - Applies to: CamEmu, CameraLink and ace GigE
        PixelSize_Bpp36,  //!< The pixel depth in the acquired images is 36 bits per pixel - Applies to: CameraLink and ace GigE
    ...
    enum TestPatternEnums
    {
        ...
        TestPattern_Testimage6,  //!< The camera generates a test image with the test image 6 pattern - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
    ...
    //**************************************************************************************************
    // Parameter class CUniversalCameraParams_Params_v10_0_0
    //**************************************************************************************************
    ...
    The \ref sample_ParametrizeCamera_NativeParameterAccess code sample shows how to access camera parameters via the \c Pylon::CBaslerUniversalInstantCamera class.
    */
    class PYLONBASE_API CUniversalCameraParams_Params_v10_0_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    ...
    //! \cond HIDE_CLASS_METHODS
        ...
        //! Constructor
        CUniversalCameraParams_Params_v10_0_0( void );
    ...
    private:
        class CUniversalCameraParams_Params_v10_0_0_Data;
        CUniversalCameraParams_Params_v10_0_0_Data* m_pCUniversalCameraParams_Params_v10_0_0_Data;
    ...
    public:
        ...
        */
        ...
        //@{
        /*!
            \brief Lower limit of the Exposure Time parameter when the Exposure Auto auto function is active - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Upper limit of the Exposure Time parameter when the Exposure Auto auto function is active - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets how gain and exposure time will be balanced when the camera is making automatic adjustments - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Height of the auto function ROI (in pixels) - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Highlights the current auto function ROI in the image window - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Horizontal offset of the auto function ROI from the left side of the sensor (in pixels) - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Vertical offset from the top of the sensor to the auto function ROI (in pixels) - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which auto function ROI can be configured - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Assigns the Gain Auto and the Exposure Auto auto functions to the currently selected auto function ROI - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Assigns the Balance White Auto auto function to the currently selected auto function ROI - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Width of the auto function ROI (in pixels) - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Lower limit of the Gain parameter when the Gain Auto auto function is active - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Upper limit of the Gain parameter when the Gain Auto auto function is active - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Target brightness for the Gain Auto and the Exposure Auto auto functions - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Balance Ratio value to be applied to the currently selected channel - Applies to: Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which color channel can be adjusted when performing manual white balance - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the operation mode of the Balance White Auto auto function - Applies to: CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, boost V CoaXPress, dart GigE, dart MIPI, dart USB, pulse USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the status of the target brightness adjustments performed by the Exposure Auto and Gain Auto auto functions - Applies to: ace 2 GigE, ace 2 USB, dart GigE and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables color adjustment - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Hue adjustment value to be applied to the currently selected color channel - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Saturation adjustment value to be applied to the currently selected color channel - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which color in your images will be adjusted - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the color space for image acquisitions - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the conversion gain mode - Applies to: ace 2 GigE and ace 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Hue shift value to be applied - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the light source preset - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables adjustment of the selected feature - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which features the camera adjusts when you select a light source preset - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, dart USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Saturation value to be applied - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables color transformation - Applies to: ace 2 CXP, ace 2 GigE, ace 2 USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which type of color transformation will be performed - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Transformation value for the selected element in the color transformation matrix - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which element will be entered in the color transformation matrix - Applies to: CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Bandwidth limit for data transmission (in bytes per second) - Applies to: CamEmu, Stereo ace, ace 2 GigE, ace 2 USB, ace USB, dart GigE, dart USB, pulse USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Enables/disables the device link throughput limit - Applies to: CamEmu, Stereo ace, ace 2 GigE, ace 2 USB, ace USB, dart GigE, dart USB, pulse USB, racer 2S 5GigE and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the operation mode of the Exposure Auto auto function - Applies to: CamEmu, CameraLink, Stereo ace, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the exposure time mode - Applies to: ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, racer 2S 5GigE, racer 2S CXP and racer 2S GigE
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the operation mode of the Gain Auto auto function - Applies to: CamEmu, CameraLink, ace 2 CXP, ace 2 GigE, ace 2 USB, ace GigE, ace USB, boost CoaXPress, dart GigE, dart MIPI, dart USB and pulse USB
  ...
  errors causing planar surfaces to appear curved.
    ...
    //! \cond HIDE_CLASS_METHODS
        ...
        CUniversalCameraParams_Params_v10_0_0(CUniversalCameraParams_Params_v10_0_0&);

        //! not implemented assignment operator
        CUniversalCameraParams_Params_v10_0_0& operator=(CUniversalCameraParams_Params_v10_0_0&);
    ...
    The \ref sample_ParametrizeCamera_NativeParameterAccess code sample shows how to access camera parameters via the \c Pylon::CBaslerUniversalInstantCamera class.
    */
    class CUniversalCameraParams_Params : public CUniversalCameraParams_Params_v10_0_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    protected:
        ...
        {
            CUniversalCameraParams_Params_v10_0_0::_Initialize( pNodeMap );
        }
        //! \endcond
    };
} // namespace Basler_UniversalCameraParams
