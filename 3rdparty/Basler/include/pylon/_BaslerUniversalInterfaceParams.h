...
namespace Basler_UniversalInterfaceParams
{
    ...
    //**************************************************************************************************
    // Parameter class CUniversalInterfaceParams_Params_v10_0_0
    //**************************************************************************************************
    

    //! A parameter class containing all parameters as members that are available for pylon interfaces
    class PYLONBASE_API CUniversalInterfaceParams_Params_v10_0_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    ...
    //! \cond HIDE_CLASS_METHODS
        ...
        //! Constructor
        CUniversalInterfaceParams_Params_v10_0_0( void );
    ...
    private:
        class CUniversalInterfaceParams_Params_v10_0_0_Data;
        CUniversalInterfaceParams_Params_v10_0_0_Data* m_pCUniversalInterfaceParams_Params_v10_0_0_Data;
    ...
    //! \cond HIDE_CLASS_METHODS
        ...
        CUniversalInterfaceParams_Params_v10_0_0(CUniversalInterfaceParams_Params_v10_0_0&);

        //! not implemented assignment operator
        CUniversalInterfaceParams_Params_v10_0_0& operator=(CUniversalInterfaceParams_Params_v10_0_0&);
    ...
    //! A parameter class containing all parameters as members that are available for pylon interfaces
    class CUniversalInterfaceParams_Params : public CUniversalInterfaceParams_Params_v10_0_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    protected:
        ...
        {
            CUniversalInterfaceParams_Params_v10_0_0::_Initialize( pNodeMap );
        }
        //! \endcond
    };
} // namespace Basler_UniversalInterfaceParams
