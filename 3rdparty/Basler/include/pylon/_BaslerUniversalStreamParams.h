...
namespace Basler_UniversalStreamParams
{
    ...
    //**************************************************************************************************
    // Parameter class CUniversalStreamParams_Params_v10_0_0
    //**************************************************************************************************
    ...
    The \ref sample_ParametrizeCamera_NativeParameterAccess code sample shows how to access camera parameters via the \c Pylon::CBaslerUniversalInstantCamera class.
    */
    class PYLONBASE_API CUniversalStreamParams_Params_v10_0_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    ...
    //! \cond HIDE_CLASS_METHODS
        ...
        //! Constructor
        CUniversalStreamParams_Params_v10_0_0( void );
    ...
    private:
        class CUniversalStreamParams_Params_v10_0_0_Data;
        CUniversalStreamParams_Params_v10_0_0_Data* m_pCUniversalStreamParams_Params_v10_0_0_Data;
    ...
    //! \cond HIDE_CLASS_METHODS
        ...
        CUniversalStreamParams_Params_v10_0_0(CUniversalStreamParams_Params_v10_0_0&);

        //! not implemented assignment operator
        CUniversalStreamParams_Params_v10_0_0& operator=(CUniversalStreamParams_Params_v10_0_0&);
    ...
    The \ref sample_ParametrizeCamera_NativeParameterAccess code sample shows how to access camera parameters via the \c Pylon::CBaslerUniversalInstantCamera class.
    */
    class CUniversalStreamParams_Params : public CUniversalStreamParams_Params_v10_0_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    protected:
        ...
        {
            CUniversalStreamParams_Params_v10_0_0::_Initialize( pNodeMap );
        }
        //! \endcond
    };
} // namespace Basler_UniversalStreamParams
